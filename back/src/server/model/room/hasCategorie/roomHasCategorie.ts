...
export class RoomHasCategorie {
    ...
    public select(roomHasCategorie: IModelRoomHasCategorie): Promise<IModelRoomHasCategorie[]> {
        return SkillzboxDatabaseKnex.getInstance().select(RoomHasCategorie.TABLE_NAME)
